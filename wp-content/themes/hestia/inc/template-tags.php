...
function hestia_the_footer_content() {
	$hestia_general_credits = get_theme_mod( 'hestia_general_credits',
		/* translators: %1$s is Theme Name */
		sprintf( esc_html__( 'Copyright © All right reserved '.date('Y').' %1$s', 'hestia' ),
			/* translators: %s is Theme name */
			sprintf( '<a href="http://zodia-q.com/" target="_blank" rel="nofollow">%s</a>',
				esc_html__( ' ZODIAQ Asia Inc.', 'hestia' )
			)
		)
	);
		...
		<div class="container">
			...
			<div id="top-menu" class="row hidden-xs">
				...
				<div class="col-md-6 pad-r-0">
					<div class="pull-right switch-languages">
						<?php echo polylang_shortcode(); ?>
					</div>
					<div class="social-icon text-right pull-right">
